...
def reorder_matrix(row_order, column_order, matrix):
  rearranged_matrix = matrix[:, column_order]
  rearranged_matrix = rearranged_matrix[row_order, :]
...
def merge_subsystem_result_to_parent(subsystem, model):
  # take solution values and put into original model

  return 
def merge_subsystem_results_to_parent(subsystems, model, solver_success):
  return
